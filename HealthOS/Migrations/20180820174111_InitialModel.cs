    ...
    public partial class InitialModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BloodPreasures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BloodPreasures_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SentFromId = table.Column<string>(nullable: true),
                    Title = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatMessagesFrom", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<string>(nullable: true),
                    ConsumptionMethod = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Drugs_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GlucoseLevels_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Heights_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NextDoctorVisits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NextDoctorVisits_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Weights_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BloodPreasures_ApplicationUserId",
                table: "BloodPreasures",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Drugs_ApplicationUserId",
                table: "Drugs",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GlucoseLevels_ApplicationUserId",
                table: "GlucoseLevels",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Heights_ApplicationUserId",
                table: "Heights",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_NextDoctorVisits_ApplicationUserId",
                table: "NextDoctorVisits",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Weights_ApplicationUserId",
                table: "Weights",
                column: "ApplicationUserId");
        }
