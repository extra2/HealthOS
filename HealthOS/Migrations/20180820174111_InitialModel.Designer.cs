...
namespace HealthOS.Migrations
{
    ...
    [Migration("20180820174111_InitialModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthOS.Models.ChatMessageTo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("ChatMessageFromId");

                    b.Property<string>("SentToId");

                    b.HasKey("Id");

                    b.HasIndex("ChatMessageFromId")
                        .IsUnique();

                    b.HasIndex("SentToId");

                    b.ToTable("ChatMessagesTo");
                });
            ...
            modelBuilder.Entity("HealthOS.Models.ChatMessage", b =>
                {
                    b.HasOne("HealthOS.Models.ApplicationUser", "SentFrom")
            ...
            modelBuilder.Entity("HealthOS.Models.ChatMessageTo", b =>
                {
                    b.HasOne("HealthOS.Models.ChatMessage", "ChatMessage")
                        .WithOne("ChatMessageTo")
                        .HasForeignKey("HealthOS.Models.ChatMessageTo", "ChatMessageFromId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("HealthOS.Models.ApplicationUser", "SentTo")
                        .WithMany("MessageTo")
